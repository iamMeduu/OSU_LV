...
def do_learning(name, batch_size=32, optimizer='adam', use_small_model=False, use_small_dataset=False):
    print(name)
...
'''
BASELINE:
    Prestao nakon 8 epoha - najbolji model nakon 3 epohe
    Tocnost na testu: 62.24
    Vrijeme po epohi: 18 - 15 s

SMALL BATCH:
    Prestao nakon 7 epoha - najbolji model nakon 2 epohe
    Tocnost na testnom skupu podataka 60
